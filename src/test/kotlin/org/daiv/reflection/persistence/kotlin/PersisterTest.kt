...
class PersisterTest : Spek({
                               ...
                               val s = ObjectToTest(simpleObject,
                                                    "(x Int PRIMARY KEY NOT NULL, y Text NOT NULL)",
                               ...
                               val p = ObjectToTest(persisterObject,
                                                    "(i1 Int PRIMARY KEY NOT NULL, d2 Double NOT NULL, i2 Int NOT NULL, s1 Text NOT NULL)",
                                                    "(i1, d2, i2, s1 ) VALUES (5, 3.0, 1, \"Hallo\")",
                                                    "JavaSimpleObject", 5)
                               val c = ObjectToTest(ComplexObject(3, 6, persisterObject),
                                                    "(i1 Int PRIMARY KEY NOT NULL, i3 Int NOT NULL, p1_i1 Int NOT NULL, p1_d2 Double NOT NULL, p1_i2 Int NOT NULL, p1_s1 Text NOT NULL)",
                                                    "(i1, i3, p1_i1, p1_d2, p1_i2, p1_s1 ) VALUES (3, 6, 5, 3.0, 1, \"Hallo\")",
                                                    "JavaComplexObject", 3)
                               val k = ObjectToTest(ComplexKObject(1, simpleObject),
                                                    "(x Int PRIMARY KEY NOT NULL, y_x Int NOT NULL, y_y Text NOT NULL)",
